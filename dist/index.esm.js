...
var DefaultSeparator = React.createElement(Icon$P, { color: "currentColor", width: "24px" });
...
var FallingBunnies = function (_a) {
    ...
    var bunnies = __spreadArray([], Array(count)).map(function (_, index) { return (React.createElement(Bunny, { key: String(index), position: Math.random() * 100, iterations: iterations, duration: duration },
        React.createElement(Icon$H, { width: size, height: size }))); });
...
var RotatingPancakeIcon = styled(Icon$o)(templateObject_4$3 || (templateObject_4$3 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), rotate);
        ...
        React.createElement(ModalHeader, null,
            React.createElement(ModalTitle, null,
                onBack && (React.createElement(IconButton, { variant: "text", onClick: onBack, "area-label": "go back", mr: "8px" },
                    React.createElement(Icon$10, { color: "primary" }))),
...
var Logo = function (_a) {
    ...
    var innerLogo = (React.createElement(React.Fragment, null,
        React.createElement("span", { className: "desktop-icon-text" }, "Pancake")));
    return (React.createElement(StyleFlex, null,
        React.createElement(MenuButton, { className: "btn-toggle-menu", "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React.createElement(Icon$k, { width: "24px", color: "#5F5E76" })) : (React.createElement(Icon$l, { width: "24px", color: "#0085FF" }))),
...
var Accordion = function (_a) {
    ...
    return (React.createElement(Container$2, null,
        React.createElement(MenuEntry, { onClick: handleClick, className: className, isActive: isActive },
            ...
            isOpen ? React.createElement(Icon$Z, null) : React.createElement(Icon$_, null)),
...
var StyledPanel = styled.div(templateObject_1$9 || (templateObject_1$9 = __makeTemplateObject(["\n  position: fixed;\n  padding-top: ", ";\n  top: 0;\n  left: 0;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  flex-shrink: 0;\n  background: ", ";\n  width: ", ";\n  height: 100vh;\n  transition: padding-top 0.2s, width 0.2s;\n  border-right: ", ";\n  z-index: 11;\n  overflow: ", ";\n  transform: translate3d(0, 0, 0);\n  padding-top: ", "px;\n\n  ", " {\n    width: ", ";\n    padding-top: ", ";\n  }\n"], ["\n  position: fixed;\n  padding-top: ", ";\n  top: 0;\n  left: 0;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  flex-shrink: 0;\n  background: ", ";\n  width: ", ";\n  height: 100vh;\n  transition: padding-top 0.2s, width 0.2s;\n  border-right: ", ";\n  z-index: 11;\n  overflow: ", ";\n  transform: translate3d(0, 0, 0);\n  padding-top: ", "px;\n\n  ", " {\n    width: ", ";\n    padding-top: ", ";\n  }\n"])), function (_a) {
    ...
    var showMenu = _a.showMenu;
    return (showMenu ? MENU_HEIGHT + "px" : '32px');
});
...
var ConnectModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss },
        ...
        React.createElement(HelpLink, { href: "https://docs.pancakeswap.finance/guides/faq#how-do-i-set-up-my-wallet-on-binance-smart-chain", external: true },
            React.createElement(Icon$J, { color: "primary", mr: "6px" }),
...
var CopyToClipboard = function (_a) {
    ...
    return (React.createElement(StyleButton$2, __assign({ small: true, bold: true, onClick: function () {
        ...
        children,
        React.createElement(Icon$K, { width: "20px", color: "primary", ml: "4px" }),
...
var StyleChevronDownIcon = styled(Icon$R)(templateObject_2$2 || (templateObject_2$2 = __makeTemplateObject(["\n  color: ", ";\n"], ["\n  color: ", ";\n"])), function (_a) {
    var theme = _a.theme;
    return theme.isDark ? 'rgba(255, 255, 255, 0.87)' : '#6F6C99';
});
...
var StyleNoProfileAvatar = styled(Icon$E)(templateObject_3$1 || (templateObject_3$1 = __makeTemplateObject(["\n  width: 37px;\n  height: 37px;\n\n  ", " {\n    width: 56px;\n    height: 56px;\n  }\n"], ["\n  width: 37px;\n  height: 37px;\n\n  ", " {\n    width: 56px;\n    height: 56px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.nav;
});
...
export { Icon$11 as AddIcon, Alert, Icon$10 as ArrowBackIcon, Icon$$ as ArrowDownIcon, Icon$_ as ArrowDropDownIcon, Icon$Z as ArrowDropUpIcon, Icon$Y as ArrowForwardIcon, Icon$X as AutoRenewIcon, BackgroundImage, GridLayout$1 as BaseLayout, Icon$W as BinanceIcon, Icon$13 as BlockIcon, Box, Breadcrumbs, Icon$V as BunnyPlaceholderIcon, Button, ButtonMenu, ButtonMenuItem, Icon$T as CalculateIcon, Card, CardBody, CardFooter, CardHeader, CardRibbon, Icon$U as CardViewIcon, GridLayout as CardsLayout, Checkbox, Icon$15 as CheckmarkCircleIcon, Icon$S as CheckmarkIcon, Icon$R as ChevronDownIcon, Icon$Q as ChevronLeftIcon, Icon$P as ChevronRightIcon, Icon$O as ChevronUpIcon, Icon$N as CloseIcon, Icon$M as CogIcon, Icon$L as CommunityIcon, ConnectorNames, Icon$K as CopyIcon, Dropdown, Icon$14 as ErrorIcon, FallingBunnies, Flex, Heading, Icon$J as HelpIcon, IconButton, Image, Icon$12 as InfoIcon, Input$1 as Input, Link, LinkExternal, Icon$I as ListViewIcon, Icon$H as LogoIcon, Icon$G as LogoRoundIcon, Menu, Icon$F as MinusIcon, Modal, ModalProvider, Icon$E as NoProfileAvatarIcon, Icon$D as OpenNewIcon, Icon$B as PancakeRoundIcon, Icon$C as PancakesIcon, Icon$A as PrizeIcon, Progress, Icon$x as ProgressBunny, Radio, Icon$z as RemoveIcon, ResetCSS, Icon$t as SearchIcon, Skeleton, Spinner, Svg, Icon$s as SwapVertIcon, Icon$r as SyncAltIcon, Tag, Text, Icon$v as Ticket, Icon$u as TicketRound, ToastContainer, Toggle, Icon$y as VerifiedIcon, Icon$q as WarningIcon, Icon$w as Won, variants as alertVariants, byTextAscending, byTextDescending, connectorLocalStorageKey, darkTheme as dark, darkColors, lightTheme as light, lightColors, makeRender, links as menuConfig, types as toastTypes, useKonamiCheatCode, useMatchBreakpoints, useModal, useParticleBurst, useTable, useWalletModal };

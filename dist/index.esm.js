...
var StyledTag = styled.div(templateObject_1$v || (templateObject_1$v = __makeTemplateObject(["\n  align-items: center;\n  background-color: ", ";\n  border: 2px solid ", ";\n  border-radius: 16px;\n  color: ", ";\n  display: inline-flex;\n  font-size: 14px;\n  font-weight: 400;\n  height: 28px;\n  line-height: 1.5;\n  padding: 0 8px;\n  white-space: nowrap;\n\n  svg {\n    fill: ", ";\n  }\n"], ["\n  align-items: center;\n  background-color: ",
    ";\n  border: 2px solid ", ";\n  border-radius: 16px;\n  color: ", ";\n  display: inline-flex;\n  font-size: 14px;\n  font-weight: 400;\n  height: 28px;\n  line-height: 1.5;\n  padding: 0 8px;\n  white-space: nowrap;\n\n  svg {\n    fill: ", ";\n  }\n"])), function (_a) {
...
var StyledLink$2 = styled(Text)(templateObject_1$u || (templateObject_1$u = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  width: fit-content;\n  &:hover {\n    text-decoration: underline;\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  width: fit-content;\n  &:hover {\n    text-decoration: underline;\n  }\n"])));
...
var BoxLink = styled(Link)(templateObject_1$t || (templateObject_1$t = __makeTemplateObject(["\n  background: ", ";\n  width: 37px;\n  height: 37px;\n  border-radius: 50%;\n  line-height: 37px;\n  display: flex;\n  justify-content: center;\n  margin-left: 6px;\n  margin-right: 0px;\n"], ["\n  background: ", ";\n  width: 37px;\n  height: 37px;\n  border-radius: 50%;\n  line-height: 37px;\n  display: flex;\n  justify-content: center;\n  margin-left: 6px;\n  margin-right: 0px;\n"])), function (_a) {
    var theme = _a.theme;
...
var LinkExternal = function (_a) {
    ...
    return (React.createElement(BoxLink, __assign({ external: true }, props),
        children,
        React.createElement(Icon$F, { width: "20px", color: "primary" })));
};
var templateObject_1$t;
...
var rotate = keyframes(templateObject_1$q || (templateObject_1$q = __makeTemplateObject(["\n  from {\n    transform: rotate(0deg);\n  }\n  to {\n    transform: rotate(360deg);\n  }\n"], ["\n  from {\n    transform: rotate(0deg);\n  }\n  to {\n    transform: rotate(360deg);\n  }\n"])));
var float = keyframes(templateObject_2$d || (templateObject_2$d = __makeTemplateObject(["\n\t0% {\n\t\ttransform: translatey(0px);\n\t}\n\t50% {\n\t\ttransform: translatey(10px);\n\t}\n\t100% {\n\t\ttransform: translatey(0px);\n\t}\n"], ["\n\t0% {\n\t\ttransform: translatey(0px);\n\t}\n\t50% {\n\t\ttransform: translatey(10px);\n\t}\n\t100% {\n\t\ttransform: translatey(0px);\n\t}\n"])));
...
var Handle = styled.div(templateObject_1$o || (templateObject_1$o = __makeTemplateObject(["\n  background-color: ", ";\n  border-radius: 50%;\n  cursor: pointer;\n  height: ", ";\n  left: ", ";\n  position: absolute;\n  top: ", ";\n  transition: left 200ms ease-in;\n  width: ", ";\n  z-index: 1;\n"], ["\n  background-color: ", ";\n  border-radius: 50%;\n  cursor: pointer;\n  height: ", ";\n  left: ", ";\n  position: absolute;\n  top: ", ";\n  transition: left 200ms ease-in;\n  width: ", ";\n  z-index: 1;\n"])), function (_a) {
    var theme = _a.theme;
...
var StyledModal = styled.div(templateObject_1$n || (templateObject_1$n = __makeTemplateObject(["\n  background: ", ";\n  border: 1px solid ", ";\n  box-shadow: 50px 38px 102px rgba(120, 118, 148, 0.14);\n  border-radius: 40px;\n  width: 100%;\n  z-index: ", ";\n  overflow-y: auto;\n  ", " {\n    width: auto;\n    min-width: 360px;\n    max-width: 100%;\n  }\n"], ["\n  background: ", ";\n  border: 1px solid ", ";\n  box-shadow: 50px 38px 102px rgba(120, 118, 148, 0.14);\n  border-radius: 40px;\n  width: 100%;\n  z-index: ", ";\n  overflow-y: auto;\n  ", " {\n    width: auto;\n    min-width: 360px;\n    max-width: 100%;\n  }\n"])), function (_a) {
    var theme = _a.theme;
...
var Overlay = styled.div.attrs({ role: "presentation" })(templateObject_1$m || (templateObject_1$m = __makeTemplateObject(["\n  position: fixed;\n  top: 0px;\n  left: 0px;\n  width: 100%;\n  height: 100%;\n  background-color: #452a7a;\n  transition: opacity 0.4s;\n  opacity: ", ";\n  z-index: ", ";\n  pointer-events: ", ";\n"], ["\n  position: fixed;\n  top: 0px;\n  left: 0px;\n  width: 100%;\n  height: 100%;\n  background-color: #452a7a;\n  transition: opacity 0.4s;\n  opacity: ", ";\n  z-index: ", ";\n  pointer-events: ", ";\n"])), function (_a) {
    var show = _a.show;
    return (show ? 0.6 : 0);
}, function (_a) {
...
var ModalWrapper = styled.div(templateObject_1$l || (templateObject_1$l = __makeTemplateObject(["\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n  position: fixed;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  left: 0;\n  z-index: ", ";\n"], ["\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n  position: fixed;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  left: 0;\n  z-index: ", ";\n"])), function (_a) {
    var theme = _a.theme;
...
var StyledLink$1 = styled(Link$1)(templateObject_1$j || (templateObject_1$j = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  .mobile-icon {\n    width: 32px;\n    ", " {\n      display: none;\n    }\n  }\n  .desktop-icon {\n    width: 156px;\n    display: none;\n    ", " {\n      display: block;\n    }\n  }\n  .desktop-icon-text {\n    color: ", ";\n    display: none;\n    padding: 0 22px;\n    font-weight: 800;\n    font-size: 32px;\n    line-height: 39px;\n    letter-spacing: -0.04em;\n    ", " {\n      display: block;\n    }\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  .mobile-icon {\n    width: 32px;\n    ", " {\n      display: none;\n    }\n  }\n  .desktop-icon {\n    width: 156px;\n    display: none;\n    ", " {\n      display: block;\n    }\n  }\n  .desktop-icon-text {\n    color: ", ";\n    display: none;\n    padding: 0 22px;\n    font-weight: 800;\n    font-size: 32px;\n    line-height: 39px;\n    letter-spacing: -0.04em;\n    ", " {\n      display: block;\n    }\n  }\n"])), function (_a) {
    var theme = _a.theme;
...
var StyleFlex = styled(Flex)(templateObject_2$9 || (templateObject_2$9 = __makeTemplateObject(["\n  margin-right: auto;\n  height: 100%;\n  align-items: center;\n  ", " {\n    width: ", "px;\n    margin-left: -8px;\n  }\n  .btn-toggle-menu {\n    display: block;\n    ", " {\n      display: none;\n    }\n  }\n"], ["\n  margin-right: auto;\n  height: 100%;\n  align-items: center;\n  ", " {\n    width: ", "px;\n    margin-left: -8px;\n  }\n  .btn-toggle-menu {\n    display: block;\n    ", " {\n      display: none;\n    }\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.nav;
...
var rainbowAnimation = keyframes(templateObject_1$i || (templateObject_1$i = __makeTemplateObject(["\n  0%,\n  100% {\n    background-position: 0 0;\n  }\n  50% {\n    background-position: 100% 0;\n  }\n"], ["\n  0%,\n  100% {\n    background-position: 0 0;\n  }\n  50% {\n    background-position: 100% 0;\n  }\n"])));
...
var Container$1 = styled.div(templateObject_1$g || (templateObject_1$g = __makeTemplateObject(["\n  display: flex;\n  flex-direction: column;\n  overflow-y: auto;\n  overflow-x: hidden;\n  height: 100%;\n"], ["\n  display: flex;\n  flex-direction: column;\n  overflow-y: auto;\n  overflow-x: hidden;\n  height: 100%;\n"])));
...
var SocialLinks = function () { return (React.createElement(Flex, { style: { paddingTop: 8 } }, socials.map(function (social, index) {
    ...
    if (social.items) {
        return (React.createElement(Dropdown, { key: social.label, position: "top", target: React.createElement(Icon, __assign({}, iconProps, { mr: mr })) }, social.items.map(function (item) { return (React.createElement(Link, { external: true, key: item.label, href: item.href, "aria-label": item.label, color: "#FFFFFF" }, item.label)); })));
    }
...
var SocialEntry = styled.div(templateObject_2$6 || (templateObject_2$6 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  height: ", "px;\n  border-top: solid 1px;\n  border-color: rgba(255, 255, 255, 0.2);\n  padding: 0 5px;\n"], ["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  height: ", "px;\n  border-top: solid 1px;\n  border-color: rgba(255, 255, 255, 0.2);\n  padding: 0 5px;\n"])), MENU_ENTRY_HEIGHT);
...
var TextStyle = styled(Text)(templateObject_2$5 || (templateObject_2$5 = __makeTemplateObject(["\n  color: ", ";\n"], ["\n  color: ", ";\n"])), function (_a) {
    var theme = _a.theme;
    return theme.isDark ? 'rgba(255, 255, 255, 0.87)' : '#5F5E76';
});
var WalletCard = function (_a) {
    ...
    return (React.createElement(ButtonStyle, { variant: "tertiary", onClick: function () {
        ...
        React.createElement(Icon, { width: "32px", style: { marginRight: 46 } }),
        React.createElement(TextStyle, { bold: true, color: "primary", mr: "16px" }, title)));
};
...
var CopyToClipboard = function (_a) {
    ...
    return (React.createElement(StyleButton$2, __assign({ small: true, bold: true, onClick: function () {
        ...
        children,
        React.createElement(Icon$M, { width: "20px", color: "primary" }),

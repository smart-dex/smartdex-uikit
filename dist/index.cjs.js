...
var FallingBunnies = function (_a) {
    ...
    var bunnies = __spreadArray([], Array(count)).map(function (_, index) { return (React__default['default'].createElement(Bunny, { key: String(index), position: Math.random() * 100, iterations: iterations, duration: duration },
        React__default['default'].createElement(Icon$H, { width: size, height: size }))); });
...
var LinkExternal = function (_a) {
    ...
    return (React__default['default'].createElement(Link, __assign({ external: true }, props),
        children,
        React__default['default'].createElement(Icon$D, { color: "primary", ml: "4px" })));
};
...
var RotatingPancakeIcon = styled__default['default'](Icon$o)(templateObject_4$3 || (templateObject_4$3 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), rotate);
var FloatingPanIcon = styled__default['default'](Icon$p)(templateObject_5$2 || (templateObject_5$2 = __makeTemplateObject(["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
...
var Logo = function (_a) {
    ...
    var innerLogo = (React__default['default'].createElement(React__default['default'].Fragment, null,
        React__default['default'].createElement("span", { className: "desktop-icon-text" }, "Pancake")));
    return (React__default['default'].createElement(StyleFlex, null,
        React__default['default'].createElement(MenuButton, { className: "btn-toggle-menu", "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React__default['default'].createElement(Icon$k, { width: "24px", color: "#5F5E76" })) : (React__default['default'].createElement(Icon$l, { width: "24px", color: "#0085FF" }))),
...
var StyleChevronDownIcon = styled__default['default'](Icon$R)(templateObject_2$2 || (templateObject_2$2 = __makeTemplateObject(["\n  color: ", ";\n"], ["\n  color: ", ";\n"])), function (_a) {
    var theme = _a.theme;
    return theme.isDark ? 'rgba(255, 255, 255, 0.87)' : '#6F6C99';
});
...
var StyleNoProfileAvatar = styled__default['default'](Icon$E)(templateObject_3$1 || (templateObject_3$1 = __makeTemplateObject(["\n  width: 37px;\n  height: 37px;\n\n  ", " {\n    width: 56px;\n    height: 56px;\n  }\n"], ["\n  width: 37px;\n  height: 37px;\n\n  ", " {\n    width: 56px;\n    height: 56px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.nav;
});
...
exports.NoProfileAvatarIcon = Icon$E;
exports.OpenNewIcon = Icon$D;
exports.PancakeRoundIcon = Icon$B;
exports.PancakesIcon = Icon$C;
...
exports.Svg = Svg;
exports.SwapVertIcon = Icon$s;
exports.SyncAltIcon = Icon$r;
exports.Tag = Tag;
exports.Text = Text;
exports.Ticket = Icon$v;
exports.TicketRound = Icon$u;
exports.ToastContainer = ToastContainer;
exports.Toggle = Toggle;
exports.VerifiedIcon = Icon$y;
exports.WarningIcon = Icon$q;
exports.Won = Icon$w;
